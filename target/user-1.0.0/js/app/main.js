...
window.UserView = Backbone.View.extend({
    ...
    checkUser: function() {
        ...
        if ($.isNumeric($('#name').val()) === true) {
            ...
            $('.error#e1').removeClass("error").addClass("error-show");
            $('#name').addClass("name-error");

        }
        if ($.isNumeric($('#secondName').val()) === true) {
            isValid = false;
            $('.error#e2').removeClass("error").addClass("error-show");
            $('#secondName').addClass("secondName-error");
        }
        if ($.isNumeric($('#age').val()) === false) {
            isValid = false;
            $('.error#e3').removeClass("error").addClass("error-show");
